...
int main(int argc, char** argv) {
    try {
        ...
        emit_native_status(
            "method.conv2d.backend.native_runner.process.start",
            {
                json_string_field("status", "running"),
                json_string_field("method", "conv2d"),
        ...
        emit_native_status(
            "method.conv2d.backend.native_runner.setup.start",
            {
                json_string_field("status", "running"),
                json_string_field("method", "conv2d"),
                json_string_field("backend", "dx12"),
        ...
        emit_native_status(
            "method.conv2d.backend.native_runner.setup.complete",
            {
                json_string_field("status", "running"),
                json_string_field("method", "conv2d"),
                json_string_field("backend", "dx12"),
        ...
        if (options.task_mode) {
            emit_native_status(
                "method.conv2d.backend.native_runner.task.measurement.start",
                {
                    json_string_field("status", "running"),
                    json_string_field("method", "conv2d"),
                    json_string_field("backend", "dx12"),
            ...
            emit_native_status(
                "method.conv2d.backend.native_runner.task.measurement.complete",
                {
                    json_string_field("status", "running"),
                    json_string_field("method", "conv2d"),
                    json_string_field("backend", "dx12"),
            ...
            emit_native_status(
                "method.conv2d.backend.native_runner.process.complete",
                {
        ...
        for (const int thread_group_size : options.thread_group_sizes) {
            for (const int tile_size : options.tile_sizes) {
                ...
                emit_native_status(
                    "method.conv2d.backend.native_runner.autotune.trial.start",
                    {
                        json_string_field("status", "running"),
                        json_string_field("method", "conv2d"),
                        json_string_field("backend", "dx12"),
                ...
                emit_native_status(
                    "method.conv2d.backend.native_runner.autotune.trial.complete",
                    {
                        json_string_field("status", "running"),
                        json_string_field("method", "conv2d"),
                        json_string_field("backend", "dx12"),
        ...
        emit_native_status(
            "method.conv2d.backend.native_runner.autotune.best_selected",
            {
                json_string_field("status", "running"),
                json_string_field("method", "conv2d"),
                json_string_field("backend", "dx12"),
        ...
        emit_native_status(
            "method.conv2d.backend.native_runner.measurement.start",
            {
                json_string_field("status", "running"),
                json_string_field("method", "conv2d"),
                json_string_field("backend", "dx12"),
        ...
        emit_native_status(
            "method.conv2d.backend.native_runner.process.error",
            {
