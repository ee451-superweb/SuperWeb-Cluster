...
inline void fmvm_row_major_impl(
...
#define DEFINE_FMVM_ROW_MAJOR_KERNEL(TILE_SIZE) \
kernel void fmvm_row_major_tile_##TILE_SIZE( \
    device const float* matrix_values [[buffer(0)]], \
    device const float* vector_values [[buffer(1)]], \
    device float* output_values [[buffer(2)]], \
    constant FmvmParams& params [[buffer(3)]], \
...
DEFINE_FMVM_ROW_MAJOR_KERNEL(1)
DEFINE_FMVM_ROW_MAJOR_KERNEL(2)
DEFINE_FMVM_ROW_MAJOR_KERNEL(4)
DEFINE_FMVM_ROW_MAJOR_KERNEL(8)
DEFINE_FMVM_ROW_MAJOR_KERNEL(16)
