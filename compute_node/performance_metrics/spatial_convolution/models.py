"""Shared data objects for the spatial-convolution benchmark workspace.

Use these dataclasses when spatial benchmark code needs stable, named
...
@dataclass(slots=True)
class DatasetLayout:
    """File locations for one generated spatial benchmark dataset."""
    root_dir: Path
    input_path: Path
    weight_path: Path
    meta_path: Path
