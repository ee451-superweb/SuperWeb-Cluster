...
from app.constants import (
    ...
    DEFAULT_ARTIFACT_TRANSFER_TIMEOUT,
    DEFAULT_COMPUTE_ARTIFACT_TTL_SECONDS,
    DEFAULT_IDLE_WORKER_UPDATE_INTERVAL,
...
class AppConfig:
    ...
    idle_worker_update_interval: float = DEFAULT_IDLE_WORKER_UPDATE_INTERVAL
