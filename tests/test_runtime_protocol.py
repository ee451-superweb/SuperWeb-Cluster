...
class RuntimeProtocolTests(unittest.TestCase):
    ...
    def test_register_worker_round_trip(self) -> None:
        ...
        encoded = encode_envelope(build_register_worker("home computer", hardware))
        ...
        self.assertEqual(decoded.register_worker.node_name, "home computer")
    ...
    def test_register_ok_round_trip(self) -> None:
        encoded = encode_envelope(build_register_ok("10.0.0.5", 52020, "home scheduler"))
        decoded = parse_envelope(encoded)
        ...
        self.assertEqual(decoded.register_ok.scheduler_ip, "10.0.0.5")
        self.assertEqual(decoded.register_ok.scheduler_port, 52020)

    def test_heartbeat_ok_round_trip(self) -> None:
        encoded = encode_envelope(build_heartbeat_ok("home computer", 123456, 123999))
        decoded = parse_envelope(encoded)
        ...
        self.assertEqual(decoded.heartbeat_ok.node_name, "home computer")
    ...
    def test_client_join_request_response_round_trip(self) -> None:
        join = parse_envelope(encode_envelope(build_client_join("home client")))
        request = parse_envelope(encode_envelope(build_client_request("home client", "req-1", "cluster_status", "")))
        ...
        self.assertEqual(join.client_join.client_name, "home client")
    ...
    def test_framed_send_receive_round_trip(self) -> None:
        ...
        try:
            ...
            send_message(left, build_heartbeat("home scheduler", 123456))
